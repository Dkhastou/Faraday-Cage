...
4. Since working on this project, I have changed systems. Work is still being done on re-configuring Elmer on my current system. Once that has been done I can provide a more thorough explanation of how to run the simulation from beginning to end
